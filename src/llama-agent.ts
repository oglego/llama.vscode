...
export class LlamaAgent {
    ...
    private static readonly REASONING_ITERATION_SEPARATOR = '\n\n---\n\n';
            ...
            while (iterationsCount < this.app.configuration.tools_max_iterations){
                ...
                try {
                    ...
                    if (this.reasoningText) {
                        this.reasoningText += LlamaAgent.REASONING_ITERATION_SEPARATOR;
                        this.app.llamaWebviewProvider.logReasoningInUi(this.reasoningText);
                    }
                    const onReasoningDelta = this.app.configuration.agent_show_reasoning
                        ? (delta: string) => {
